...
class ReportMgr(ReportMgrBase):
    ...
    def _report_training(self, step, num_steps, learning_rate,
        ...
        self.maybe_log_tensorboard(report_stats,
                                   "ext_train",
                                   learning_rate,
                                   self.progress_step * self.report_every)
    ...
    def _report_step(self, lr, step, test_stats=None, valid_stats=None):
        ...
        if test_stats is not None:
            self.log('ExtSummarizer Test xent: %g' % test_stats.xent())
        ...
        if valid_stats is not None:
            self.log('ExtSummarizer Validation xent: %g at step %d' % (valid_stats.xent(), step))
...
class Statistics(object):
    ...
    * elapsed time
    ...
    def __init__(self, loss=0, n_sents=0, n_correct=0):
        self.loss = loss
    ...
    def output(self, step, num_steps, learning_rate, start):
        ...
        logger.info(
            ...
            % (step_fmt,
               ...
               time.time() - start))
        sys.stdout.flush()
        print('extractive_layer:\tloss:', self.loss, '\tn_sents:', self.n_sents)
